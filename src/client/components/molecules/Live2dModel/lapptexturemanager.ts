...
export class LAppTextureManager {
  ...
  public release(): void {
    for (
      let ite: iterator<TextureInfo> = this._textures?.begin() as iterator<TextureInfo>;
      ite.notEqual(this._textures?.end() as iterator<TextureInfo>);
      ite.preIncrement()
    ) {
  ...
  _textures: csmVector<TextureInfo | null> | null
}
